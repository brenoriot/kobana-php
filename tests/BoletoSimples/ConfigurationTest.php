...
class ConfigurationTest extends PHPUnit_Framework_TestCase
{
    public function testDefaults()
    {
        ...
        $this->assertEquals($this->subject->baseUri(), 'https://api-sandbox.kobana.com.br/v1/');
    ...
    {
        $this->subject = new BoletoSimples\Configuration();
        $this->assertEquals($this->subject->userAgent(), 'Kobana PHP Client v0.0.10 (suporte@kobana.com.br)');
    }
